...
const models: TsoaRoute.Models = {
    ...
    "EDigestAlgorithm": {
        "dataType": "refEnum",
        "enums": ["SHA1","SHA224","SHA256","SHA512"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IDigestBlobRequest": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/digest/blob',
            ...(fetchMiddlewares<RequestHandler>(DigestController)),
            ...(fetchMiddlewares<RequestHandler>(DigestController.prototype.digestBlob)),

            function DigestController_digestBlob(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"body","name":"request","required":true,"ref":"IDigestBlobRequest"},
            };
