...
export class centralServiceClient {
    public getSignedCMS(request: ISignatureRequest): Result<ISignatureResponse, Error> {
...
const centralServiceResponseMap = new Map<Base64, ISignatureResponse>([["LKzqH/84VwE6BA10+ynTrB7jjNAliRRo7I2BUCukMXU=", exampleResponse]])
