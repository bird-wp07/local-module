...
describe(`Application settings parser`, () => {
    test(`accepts valid settings`, () => {
        ...
        const csBaseUrl = ["http://46.83.201.35.bc.googleusercontent.com", "http://46.83.201.35.bc.googleusercontent.com", "http://46.83.201.35.bc.googleusercontent.com"]
